...
public class Principal {
    ...
    private void buscarAutoresVivo() {
        ...
        List<AutorEntity> autores = autorRepositorio.findByYear(anio);
    ...
    private void buscarPorIdiomas() {
        ...
        List<LibroEntity> libros = libroRepositorio.findByLanguage(seleccion);
